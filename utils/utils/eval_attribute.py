...
def parse_args():
    ...
    parser.add_argument('--test-set', type=str, default='/exdata2/RuoyuChen/Demo/MaskFaceGAN/utils/attribute2.txt')      # 属性测试集的list
    parser.add_argument('--json-path', type=str, default='/exdata2/RuoyuChen/Demo/MaskFaceGAN/json_per_ima')      # json path
