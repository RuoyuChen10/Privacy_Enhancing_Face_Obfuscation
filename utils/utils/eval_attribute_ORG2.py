...
def parse_args():
    ...
    parser.add_argument('--test-number', type=int, default=10)    # 整个测试集非常大，可以选择其中的部分，测试全部的话置-1
...
def main(args):
    ...
    print("测试结束，有效测试数据数量为{}张，属性{}的预测结果的TP为{}，ACC为{}".format(number, args.attribute, TP/(TP_num+0.00001), acc/number))
