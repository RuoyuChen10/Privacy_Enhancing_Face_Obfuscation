...
def parse_args():
    ...
    parser.add_argument('--test-set', type=str, default='/exdata2/RuoyuChen/Demo/MaskFaceGAN/utils/attribute2.txt')     
    ...
    parser.add_argument('--device', type=str, default='cuda:2')      # json path
...
def main(args):
    ...
    for stasticdata in StasticData:
        ...
        for data in tqdm(datas):
            ...
            image_path = os.path.join(args.image_dir, im_name.split(".")[0]+"-0.8.jpg")
            #print(image_path)        
