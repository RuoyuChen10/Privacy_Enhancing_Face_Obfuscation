...
if __name__ == '__main__':
    ...
    for people in peoples:
        ...
        for json_file in json_files:
            ...
            save_results(img_result, image_name.split('.')[0]+'-'+str(args.threshold)+'.jpg', outdir='./output/abresults-age-race')
            save_results(image, image_name.split('.')[0]+'-'+str(args.threshold)+'.jpg', outdir='./output/abresults_orig-age-race')
