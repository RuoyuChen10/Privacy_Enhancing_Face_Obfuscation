...
def parse_args():
    ...
    parser.add_argument('--image-root-path',type=str,default='/home/lsf/vgghq/VGGface2_None_norm_512_true_bygfpgan')
...
if __name__ == '__main__':
    ...
    # Avg_face_male, Avg_image_name, avg_target = load_data("/exdata2/RuoyuChen/Demo/MaskFaceGAN/AG-MALE-VGG.jpg", args.target, smoothing=args.smoothing)
    
    # Avg_face_female, Avg_image_name, avg_target = load_data("/exdata2/RuoyuChen/Demo/MaskFaceGAN/AG-FEMALE-VGG.jpg", args.target, smoothing=args.smoothing)    
    ...
    for people in peoples:
        ...
        for json_file in json_files:
            ...
            save_results(img_result, image_name.split('.')[0]+'-'+str(args.threshold)+'.jpg', outdir='./output')
            save_results(image, image_name.split('.')[0]+'-'+str(args.threshold)+'.jpg', outdir='./output')
